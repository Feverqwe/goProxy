...
// TrayManager manages the system tray on macOS
...
// NewTrayManager creates a new tray manager for macOS
...
func (tm *TrayManager) onReady() {
	systray.SetTemplateIcon(assets.IconSVGData, assets.IconSVGData)
